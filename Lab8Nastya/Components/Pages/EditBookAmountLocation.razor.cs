...
{
    public partial class EditBookAmountLocation
    {
        [Inject]
        ...
        {
            bookAmountLocation = await BookStoreService.GetBookAmountLocationByRecordId(RecordId);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await BookStoreService.UpdateBookAmountLocation(RecordId, bookAmountLocation);
