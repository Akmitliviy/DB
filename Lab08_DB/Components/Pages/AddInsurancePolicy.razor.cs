...
{
    public partial class AddInsurancePolicy
    {
        [Inject]
        ...
        {
            insurancePolicy = new Lab08DB.Models.CarRents.InsurancePolicy();
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await CarRentsService.CreateInsurancePolicy(insurancePolicy);
