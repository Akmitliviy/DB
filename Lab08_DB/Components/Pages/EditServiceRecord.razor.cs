...
{
    public partial class EditServiceRecord
    {
        [Inject]
        ...
        {
            serviceRecord = await CarRentsService.GetServiceRecordById(Id);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await CarRentsService.UpdateServiceRecord(Id, serviceRecord);
